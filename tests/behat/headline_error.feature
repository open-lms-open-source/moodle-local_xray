...
#
# Error to connect with headline data from xray side.
#
# @package    local_xray
...
@local @local_xray @local_xray_headline_error
Feature: Error to connect with headline data from xray side.
  ...
  @javascript
  Scenario Outline: Error to connect with headline data.
  ...
  @javascript
  Scenario Outline: Error to connect with headline data with snap theme.
  ...
  @javascript
  Scenario Outline: Error to connect with headline data with express theme.
  Roles: manager, teacher, editingteacher.
  Course formats: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Error to connect with headline data with express templates.
