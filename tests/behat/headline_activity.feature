...
#
# The number of Logged in students in the last 7 days should link to Activity Report.
#
# @package    local_xray
...
@local @local_xray @local_xray_headline_activity
Feature: The number of Logged in students in the last 7 days should link to Activity Report.
  ...
  @javascript
  Scenario Outline: Link in number of Logged in students in the last 7 days.
  ...
  @javascript
  Scenario Outline: Link in number of Logged in students in the last 7 days with snap theme.
  ...
  @javascript
  Scenario Outline: Link in number of Logged in students in the last 7 days with express theme.
  Roles: manager, teacher, editingteacher.
  Course formats: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Link in number of Logged in students in the last 7 days with express templates.
