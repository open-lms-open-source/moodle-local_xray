...
@local @local_xray @local_xray_headline_view
Feature: The headline data should be present in the course page.
  ...
  @javascript
  Scenario Outline: Headline data is displayed at the top of the initial course page.
    Roles: manager, teacher, editingteacher.
    Themes: more, clean, flexpage.
    Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    Then "#xray-nav-headline" "css_element" should exist
  ...
  @javascript
  Scenario Outline: Headline data is displayed at the top of the initial course page with snap theme.
   Roles: manager, teacher, editingteacher.
   Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Headline data is displayed at the top of the initial course page with express theme.
  Roles: manager, teacher, editingteacher.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Headline data is displayed at the top of the initial course page with express templates.
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for students.
  Themes: more, clean, flexpage.
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for guests.
  Themes: more, clean, flexpage.
  Course formats: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    And the following "courses" exist:
      | fullname | shortname | format |
      | Xray Course 01 | xray1 | <course_format> |
    And I allow guest access for xray in course "xray1"
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for students with snap theme.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for guest with snap theme.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    And the following "courses" exist:
      ...
      | Xray Course 01 | xray1 | 0 | <course_format> |
    And I allow guest access for xray in course "xray1"
    And I log in with snap as "guest"
    And I am on site homepage
    And I scroll until "Xray Course 01" "text" is visible
    And I follow "Xray Course 01"
    And I wait until the page is ready
    Then "#xray-nav-headline" "css_element" should not exist
    And "h4 .x-ray-icon-title" "css_element" should not exist
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for students with express theme.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    And the following "course enrolments" exist:
      | user | course | role |
      | student1 | xray1 | student |
    And I log in with express for xray as "student1"
    And I am on site homepage
    And I follow "Xray Course 01"
    And I wait until the page is ready
    Then "#xray-nav-headline" "css_element" should not exist
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for guests with express theme.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    And the following "courses" exist:
      ...
      | Xray Course 01 | xray1 | <course_format> |
    And I allow guest access for xray in course "xray1"
    And I log in with express for xray as "guest"
    And I am on site homepage
    And I follow "Xray Course 01"
    And I wait until the page is ready
    Then "#xray-nav-headline" "css_element" should not exist
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for students with express templates.
  Templates: minimal, cherub, dropshadow, future, joule, simple, sleek, topslide.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    Examples:
      ...
      | "dropshadow" | topics |
      | "dropshadow" | social |
      | "dropshadow" | folderview |
      | "dropshadow" | onetopic|
      | "dropshadow" | topcoll|
      | "dropshadow" | tabbedweek|
      | "dropshadow" | flexpage|
      | "future" | weeks |
      | "future" | topics |
      | "future" | social |
  ...
  @javascript
  Scenario Outline: Headline data is not displayed for guests with express templates.
  Templates: minimal, cherub, dropshadow, future, joule, simple, sleek, topslide.
  Course format: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
