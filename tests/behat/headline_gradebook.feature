...
#
# The percentage number of Average Grade in quizzes in the last 7 days should link to Risk Report.
#
# @package    local_xray
...
@local @local_xray @local_xray_headline_gradebook
Feature: The percentage number of Average Grade in quizzes in the last 7 days should link to Gradebook Report.
  ...
  @javascript
  Scenario Outline: Link in percentage number of Average Grade in quizzes in the last 7 days.
  ...
  Course formats: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
    ...
    And I wait until the page is ready
    Then "h2.xray-report-page-title" "css_element" should exist
  ...
  @javascript
  Scenario Outline: Link in percentage number of Average Grade in quizzes in the last 7 days with snap theme.
  ...
  @javascript
  Scenario Outline: Link in percentage number of Average Grade in quizzes in the last 7 days with express theme.
  Roles: manager, teacher, editingteacher.
  Course formats: weeks, topics, social, folderview, onetopic, topcoll, flexpage.
  ...
  @javascript
  Scenario Outline: Link in percentage number of Average Grade in quizzes in the last 7 days with express templates.
