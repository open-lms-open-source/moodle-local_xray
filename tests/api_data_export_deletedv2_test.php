...
/**
 * Class local_xray_api_data_export_deletev2_testcase
 * @group local_xray
 */
class local_xray_api_data_export_deletev2_testcase extends local_xray_api_data_export_base_testcase {
    ...
    public function test_user_delete_export() {
        ...
        $exportfile = $storagedir.DIRECTORY_SEPARATOR.'userlistv2_00000001.csv';
        $this->assertFileExists($exportfile);
        ...
        foreach ($iterator as $item) {
            ...
            // Expect 12 items.
            $this->assertEquals(12, count($item));
            $this->assertInternalType('numeric', $item[0]);
