...
function config_toggle_categories(YUI, data) {
    ...
    self.renderCategory = function(parentCat, cat) {
        var catStr = '<li id="cat_' + cat.id + '_li">' + '<input type="checkbox" id="cat_' + cat.id + '" value="1"' + (cat.disabled ? 'disabled="disabled"' : '') + '>' + '<label id="cat_' + cat.id + '_lbl" for="cat_' + cat.id + '" class="cat_label">' + cat.name + '&nbsp;&nbsp;</label>' + '<ul id="cat_' + cat.id + '_children"></ul>' + '</li>';
    ...
    self.renderCourse = function(parentCat, course) {
        var catStr = '<li id="course_' + course.id + '_li">' + '<input type="checkbox" id="id_courses_' + course.id + '" name="courses[' + course.id + ']" value="1" ' + (course.checked ? 'checked="checked"' : '') + (course.disabled ? 'disabled="disabled"' : '') + '>' + '<label for="id_courses_' + course.id + '" class="course_label">' + course.name + '</label>' + '</li>';
