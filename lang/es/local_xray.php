...
$string['syncfailedmail'] = 'Sincronización de datos con X-Ray Learning Analytics ha fallado ({$a->siteurl})';
...
$string['xray_no_valid_courses'] = 'No se encontraron cursos válidos dentro del servidor de X-Ray Learning Analytics. Por favor espere a que su sitio se sincronice o contacte al administrador del sistema.';
